...
class Settings(BaseSettings):
    ...
    browser_backend: str = Field(default="disabled", alias="BROWSER_BACKEND")
    camoufox_headless: bool = Field(default=True, alias="CAMOUFOX_HEADLESS")
    camoufox_timeout: int = Field(default=20, alias="CAMOUFOX_TIMEOUT")
    ...
    checko_html_enabled: bool = Field(default=False, alias="CHECKO_HTML_ENABLED")
    checko_html_base_url: str = Field(default="https://checko.ru", alias="CHECKO_HTML_BASE_URL")
    checko_html_okved_default: str = Field(default="862300", alias="CHECKO_HTML_OKVED_DEFAULT")
    checko_html_only_main_okved: bool = Field(default=True, alias="CHECKO_HTML_ONLY_MAIN_OKVED")
    checko_html_only_active: bool = Field(default=True, alias="CHECKO_HTML_ONLY_ACTIVE")
    checko_html_region: str = Field(default="", alias="CHECKO_HTML_REGION")
    checko_html_max_pages: int = Field(default=5, alias="CHECKO_HTML_MAX_PAGES")
    checko_html_concurrency: int = Field(default=5, alias="CHECKO_HTML_CONCURRENCY")
    checko_html_profile_enabled: bool = Field(default=True, alias="CHECKO_HTML_PROFILE_ENABLED")
    checko_html_profile_concurrency: int = Field(default=5, alias="CHECKO_HTML_PROFILE_CONCURRENCY")
    checko_html_max_concurrency: int = Field(default=30, alias="CHECKO_HTML_MAX_CONCURRENCY")
