...
def build_cold_call_plan_prompt(
    ...
    return "\n".join(
        [
            "TASK: SALES_INTELLIGENCE_COLD_CALL_PLAN",
            "",
            "You are preparing a cautious digital-sales cold call plan.",
            "Use only the supplied context.",
            "Do not invent facts, metrics, budgets, or internal processes.",
            "When evidence is incomplete, use hypothesis language such as may, might, could, appears, or worth checking.",
            "Return valid JSON only.",
            "Do not wrap the JSON in markdown fences.",
            "",
            "Requirements:",
            '- Set "generation_mode" to "ai".',
            '- Keep "copyable_short_script" plain text and concise for a manager to paste into chat or notes.',
            '- Preserve the supplied closing_criteria and soprano_questions structures; you may refine wording but not schema.',
            '- Every observation and likely pain must stay evidence-based or clearly framed as a hypothesis.',
            '- Include practical objection handling and a low-pressure first offer.',
            "",
            "Output contract:",
